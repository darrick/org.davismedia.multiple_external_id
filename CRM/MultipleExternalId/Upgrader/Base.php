 ...
 */
class CRM_MultipleExternalId_Upgrader_Base {

  /**
   * @var CRM_MultipleExternalId_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_MultipleExternalId_Upgrader(
        'org.davismedia.multiple_external_id',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_MultipleExternalId_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_MultipleExternalId_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
